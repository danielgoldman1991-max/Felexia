...
import { Bell, CheckCircle2, Printer, RotateCcw, Send, WalletCards, XCircle } from "lucide-react";
...
export function CustomerInvoiceDetail({ invoice, lines }: { invoice: CustomerInvoiceRecord; lines: CustomerInvoiceLineRecord[] }) {
