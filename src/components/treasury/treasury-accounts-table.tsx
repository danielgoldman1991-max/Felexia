          ...
          <tr key={row.id}>
            ...
            <Td>
              <div className="flex items-center gap-1">
                <Link href={`/tresorerie/comptes/${row.id}`}><Button type="button" variant="ghost" className="h-9 w-9 px-0" title="Voir"><Eye className="h-4 w-4" /></Button></Link>
                <Link href={`/tresorerie/comptes/${row.id}/edit`}><Button type="button" variant="ghost" className="h-9 w-9 px-0" title="Modifier"><Pencil className="h-4 w-4" /></Button></Link>
