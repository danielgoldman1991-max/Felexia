      ...
      <Card className="w-full max-w-md shadow-[var(--shadow-md)]">
        <CardHeader>
          <div className="mb-3 flex items-center gap-3">
            ...
            <p className="text-sm font-semibold text-[var(--secondary)]">Creez votre compte Felexia</p>
          </div>
          <h1 className="mt-2 text-2xl font-semibold">Inscription</h1>
          <p className="mt-1 text-sm text-[var(--muted)]">Commencez par creer votre compte administrateur.</p>
        </CardHeader>
        <CardContent>
          <SignUpForm />
        </CardContent>
