  ...
  return (
    <ModulePage>
      <div className="mb-4 flex gap-2">
        <Link className="rounded-[var(--radius-md)] border border-white/10 bg-white/[0.055] px-4 py-2 text-sm" href="/rh/paie/periodes">Périodes</Link>
        <Link className="rounded-[var(--radius-md)] border border-white/10 bg-white/[0.055] px-4 py-2 text-sm" href="/rh/paie/bulletins">Bulletins</Link>
      </div>
