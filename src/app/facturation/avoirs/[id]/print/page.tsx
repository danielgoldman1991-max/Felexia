  ...
  return (
    <main className="mx-auto max-w-5xl bg-white p-8 print:p-0">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <div className="text-right"><p>{creditNote.credit_note_number}</p><p>{formatDate(creditNote.credit_note_date)}</p>{creditNote.source_invoice_number ? <p>Facture source : {creditNote.source_invoice_number}</p> : null}</div>
      </div>
