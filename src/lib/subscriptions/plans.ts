...
export const SUBSCRIPTION_PLANS: SubscriptionPlanDefinition[] = [
  {
    code: "essentiel",
    name: "Essentiel",
    description: "Pour demarrer avec une gestion commerciale complete : ventes, achats, stock, tresorerie et comptabilite.",
    monthlyPrice: 290,
    yearlyPrice: 2900,
    currency: "MAD",
    isRecommended: false,
    ...
    featureHighlights: [
      ...
      "Comptabilite : ecritures, journaux, plan comptable, grand livre et balance",
    ...
    limitHighlights: [
      ...
      "Stockage limite",
      "Sans TVA avancee ni comptabilite avancee",
    ],
  ...
  },
  {
    code: "business",
    name: "Business",
    description: "Le pack recommande pour piloter ventes, achats, stock, TVA et comptabilite complete.",
    monthlyPrice: 690,
    yearlyPrice: 6900,
    currency: "MAD",
    isRecommended: true,
